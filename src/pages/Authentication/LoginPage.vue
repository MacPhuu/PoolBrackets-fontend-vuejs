<template>
  <q-layout class="bg-no-1 window-height window-width row justify-center items-center">
    <div class="column">
      ...
      <div class="row items-center justify-center">
        <div class="text-h6 text-white q-mb-lg">Welcome to the <span class="text-secondary">PoolBrackets.</span> live scoring.</div>
      </div>
      <div class="row">
        <q-card square bordered class="q-pa-md shadow-1">
          ...
          <q-card-actions class="q-px-md">
            <q-btn unelevated size="lg" class="full-width bg-primary text-white" label="Login" />
          </q-card-actions>
